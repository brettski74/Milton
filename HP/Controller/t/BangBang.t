...
my $interface = HP::t::MockInterface->new();
my $controller = HP::Controller::BangBang->new($config, $interface);

isa_ok($controller, 'HP::Controller::BangBang');
isa_ok($controller, 'HP::Controller::RTDController');
isa_ok($controller, 'HP::Controller');
