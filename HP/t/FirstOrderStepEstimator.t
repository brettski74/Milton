...
my $est = HP::FirstOrderStepEstimator->new(resistance => 10);
...
my $est2 = HP::FirstOrderStepEstimator->new(resistance => 0);
...
my $est3 = HP::FirstOrderStepEstimator->new();
...
my $est4 = HP::FirstOrderStepEstimator->new(resistance => 2.5);
