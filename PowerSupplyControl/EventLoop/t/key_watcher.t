...
use PowerSupplyControl::t::MockCondVar;

use warnings qw(all -uninitialized -redefine);

subtest '_keyWatcher' => sub {
  my $loop = PowerSupplyControl::t::MockEventLoop->new();
  my $evl = PowerSupplyControl::t::MockCondVar->new();
...
BEGIN {
  ...
  $index = 0;
  *PowerSupplyControl::EventLoop::ReadKey = \&ReadKey;
}
