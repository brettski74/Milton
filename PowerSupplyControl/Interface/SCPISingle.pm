package PowerSupplyControl::Interface::SCPISingle;
...
PowerSupplyControl::Interface::SCPISingle - SCPISingle interface
...
in addition to those supported by the PowerSupplyControl::Interface class, from  which it is descended.
