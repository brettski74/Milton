...
Milton::Command - Base class for all commands

=head1 SYNOPSIS

  my $self = Milton::Command->new($config);
...
This is the base class for all commands. To be loadable as commands, subclasses of Milton::Command should be placed in
the Milton::Command::* namespace and begin with a lowercase letter. Subclasses beginning with an uppercase letter should
