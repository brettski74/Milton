package Milton::Math::FirstOrderStepEstimator;
...
Milton::Math::FirstOrderStepEstimator - First-order step response estimator for electrical/thermal systems

=head1 SYNOPSIS

    use Milton::Math::FirstOrderStepEstimator;
    
    # Create estimator for a thermal system
    my $estimator = Milton::Math::FirstOrderStepEstimator->new(
...
Milton::Math::FirstOrderStepEstimator implements a first-order step response estimator for thermal systems.
...
L<Milton::Controller>, L<Milton::Math::PiecewiseLinear>
