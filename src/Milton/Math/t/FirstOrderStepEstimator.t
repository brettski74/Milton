...
my $est = Milton::Math::FirstOrderStepEstimator->new(resistance => 10);
isa_ok($est, 'Milton::Math::FirstOrderStepEstimator');
...
my $est2 = Milton::Math::FirstOrderStepEstimator->new(resistance => 0);
...
my $est3 = Milton::Math::FirstOrderStepEstimator->new();
...
my $est4 = Milton::Math::FirstOrderStepEstimator->new(resistance => 2.5);
