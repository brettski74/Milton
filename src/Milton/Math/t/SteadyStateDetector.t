...
subtest 'construction with defaults' => sub {
    my $detector = Milton::Math::SteadyStateDetector->new();
...
subtest 'construction with incomplete parameters' => sub {
    ...
    $detector = Milton::Math::SteadyStateDetector->new(
        smoothing => 0.86,
        threshold => 0.02,
        samples => 8,
        reset => undef
...
subtest 'parameter validation' => sub {
    ...
    ok(dies { Milton::Math::SteadyStateDetector->new(smoothing => 0) }, 'dies with zero smoothing');
    ok(dies { Milton::Math::SteadyStateDetector->new(smoothing => 1) }, 'dies with smoothing = 1');
    ok(dies { Milton::Math::SteadyStateDetector->new(smoothing => -0.1) }, 'dies with negative smoothing');
    ok(dies { Milton::Math::SteadyStateDetector->new(smoothing => 1.1) }, 'dies with smoothing > 1');
    
    # Test invalid threshold
    ok(dies { Milton::Math::SteadyStateDetector->new(threshold => 0) }, 'dies with zero threshold');
    ok(dies { Milton::Math::SteadyStateDetector->new(threshold => -0.1) }, 'dies with negative threshold');
    
    # Test invalid samples
    ok(dies { Milton::Math::SteadyStateDetector->new(samples => 0) }, 'dies with zero samples');
    ok(dies { Milton::Math::SteadyStateDetector->new(samples => -1) }, 'dies with negative samples');
    
    # Test invalid reset
    ok(dies { Milton::Math::SteadyStateDetector->new(threshold => 0.001, reset => 0.0005) }, 'dies with reset <= threshold');
};

# Test first measurement handling
subtest 'first measurement handling' => sub {
    my $detector = Milton::Math::SteadyStateDetector->new(smoothing => 0.5, threshold => 1.0, samples => 1);
...
subtest 'reset method' => sub {
    my $detector = Milton::Math::SteadyStateDetector->new(smoothing => 0.6, threshold => 0.1, samples => 3, reset => 0.2);
