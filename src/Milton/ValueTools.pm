...
Milton::ValueTools - A collection of functions for manipulating values.

=head1 SYNOPSIS

  use Milton::ValueTools qw(boolify checkMinimum checkMaximum checkMinMax timestamp);
