...
subtest 'Testing DataLogger construction and header' => sub {
...
subtest 'Testing Null logger' => sub {
...
subtest 'Testing hold, flush, and release methods' => sub {
  ...
  open my $fh, '<', $no_tee_logger->logFilename or die $!;
  <$fh>; # Skip header
  my $row = <$fh>; chomp $row;
...
subtest 'Debug Level Configuration' => sub {
  Milton::Config::Path::add_search_dir('t');

  Milton::DataLogger::load_debug_levels('datalogger-debug-1.cfg');
  is(get_namespace_debug_level('Milton::Interface'), 77, 'Explicit debug level for Milton::Interface');
  is(get_namespace_debug_level('Milton::Interface::SCPICommon'), 77, 'Inherited debug level for Milton::Interface::SCPICommon');
  is(get_namespace_debug_level('Milton::Interface::SCPI::Serial'), 88, 'Explicit debug level for Milton::Interface::SCPI::Serial');
  is(get_namespace_debug_level('Milton::Interface::SCPI::USBTMC'), 77, 'Explicit debug level for Milton::Interface::SCPI::USBTMC');

  Milton::DataLogger::load_debug_levels('datalogger-debug-universal.cfg');
  is(get_namespace_debug_level('Milton::Command'), 55, 'Inherited from UNIVERSAL');
  is(get_namespace_debug_level('IO::File'), 55, 'Inherited from UNIVERSAL');
  is(get_namespace_debug_level('Milton::Interface'), 88, 'Explicit debug level for Milton::Interface');
  is(get_namespace_debug_level('Milton::Interface::SCPICommon'), 0, 'Explicit debug level for Milton::Interface::SCPICommon');
  is(get_namespace_debug_level('Milton::Interface::SCPI::Serial'), 0, 'Inherited debug level for Milton::Interface::SCPI::Serial');
};
