...
subtest 'Constructor' => sub {
  ...
  my $interface = Milton::t::MockInterface->new($config);
  isa_ok($interface, 'Milton::t::MockInterface');
  isa_ok($interface, 'Milton::Interface');
...
subtest '_buildCalibration method' => sub {
  ...
  $interface = Milton::t::MockInterface->new($config);
...
subtest 'setVoltage method' => sub {
  ...
  $interface = Milton::t::MockInterface->new;
...
subtest 'getMinimumCurrent method' => sub {
    ...
    my $custom_interface = Milton::t::MockInterface->new($custom_config);
...
subtest 'getMeasurableCurrent method' => sub {
    ...
    my $fallback_interface = Milton::t::MockInterface->new($fallback_config);
