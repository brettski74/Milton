...
use PowerSupplyControl::Math::DifferencePredictor;

subtest 'zeroth order predictor' => sub {
  my $p = PowerSupplyControl::Math::DifferencePredictor->new(0);
...
subtest 'first order predictor' => sub {
  my $p = PowerSupplyControl::Math::DifferencePredictor->new(1);
...
subtest 'second order predictor' => sub {
  my $p = PowerSupplyControl::Math::DifferencePredictor->new(2);
